"""
Adopted from https://github.com/qzed/irl-maxent/blob/master/src/optimizer.py.
...
class ExpSga(Optimizer):
    ...
    Args:
        ...
        normalize: A boolean specifying if the the parameters should be
            ...
            Kivinen and Warmuth (1997).
        clip_grad_at: The threshold for gradient clipping. When it is `None` no clipping will be done.
    ...
    def __init__(self, lr, normalize=False, clip_grad_at=None):
        super().__init__()
        self.lr = lr
        self.normalize = normalize
        self.k = 0
        self.clip_grad = clip_grad_at
